  ...
  "cells": [
    ...
    },
    {
      ...
      "source": [
        ...
        "# @markdown Google Colab по умолчанию использует устаревшую математику (NumPy 1.x).\n",
        "# @markdown Нашим нейросетям требуется версия 2.1+. Этот блок обновит её и автоматически перезагрузит сервер (это нормально!).\n",
        "import os\n",
        "import sys\n",
        "import subprocess\n",
        "\n",
        ...
        "        print(\"📦 Обновление системной библиотеки NumPy (это займет 15 секунд)...\")\n",
        "        subprocess.run([sys.executable, \"-m\", \"pip\", \"install\", \"numpy>=2.1.0\", \"-q\"])\n",
        "        print(\"✅ Готово! Перезагружаю сервер Colab для применения изменений...\")\n",
        "        print(\"➡️ После перезагрузки переходите сразу к Шагу 2!\")\n",
        "        os.kill(os.getpid(), 9)\n",
        "    else:\n",
        "        print(\"✅ Система уже обновлена! Переходите к Шагу 2.\")\n",
        "except ImportError:\n",
        "    pass\n"
      ]
    },
    {
      ...
      "source": [
        ...
        "%pip install yt-dlp pydub ffmpeg-python demucs librosa python-dotenv google-generativeai onnx huggingface_hub pyrubberband hangul-romanize jamo cutlet fugashi unidecode g2p_en pypinyin num2words spacy numba git+https://github.com/m-bain/whisperx.git\n",
