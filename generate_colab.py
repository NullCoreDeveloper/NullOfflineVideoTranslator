  ...
  "cells": [
    ...
    },
    {
      ...
      "source": [
        ...
        "!pip install -q yt-dlp pydub ffmpeg-python demucs librosa python-dotenv google-generativeai onnxruntime-gpu onnx huggingface_hub pyrubberband hangul-romanize jamo cutlet fugashi unidecode g2p_en pypinyin num2words spacy \"numpy<2.0\" \"pandas<2.2.2\" git+https://github.com/m-bain/whisperx.git\n",
