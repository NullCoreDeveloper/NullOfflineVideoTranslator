  ...
  "cells": [
    ...
    },
    {
      ...
      "source": [
        ...
        "LOCAL_FILE = \"my_video.mp4\" # @param {type:\"string\"}\n",
        "# @markdown *Если выбрали Local File, загрузите ваш файл в папку video-translator слева и укажите его название здесь.*\n",
        "\n",
        "import os\n",
        "import subprocess\n",
        "\n",
        ...
        "        print(\"Пожалуйста, загрузите ваш видеофайл в панель слева (внутрь папки video-translator) и убедитесь, что имя совпадает.\")\n",
        "    else:\n",
        "        print(f\"🎥 Обработка локального файла: {LOCAL_FILE}\")\n",
        "        !python3 main.py \"{LOCAL_FILE}\"\n",
        "\n",
