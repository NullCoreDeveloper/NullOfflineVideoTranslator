  ...
  "cells": [
    ...
    },
    {
      ...
      "source": [
        ...
        "!uv pip install --system yt-dlp pydub ffmpeg-python demucs deepfilternet librosa python-dotenv google-generativeai onnx huggingface_hub pyrubberband hangul-romanize jamo cutlet fugashi unidecode g2p_en pypinyin num2words spacy numba git+https://github.com/m-bain/whisperx.git\n",
