...
help_cell = {
  ...
  "source": [
    ...
    "5. **ВАЖНО:** Для разделения голосов вам нужно принять лицензионное соглашение. Перейдите по [этой ссылке](https://huggingface.co/pyannote/speaker-diarization-3.1) и нажмите **Agree**, затем по [этой ссылке](https://huggingface.co/pyannote/segmentation-3.0) и тоже нажмите **Agree**.\n",
    "\n",
